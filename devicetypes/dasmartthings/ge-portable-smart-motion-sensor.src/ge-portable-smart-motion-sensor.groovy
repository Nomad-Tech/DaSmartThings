...
metadata {
	definition (name: "GE Portable Smart Motion Sensor", namespace: "DaSmartThings", author: "Daniel Ionescu", ocfDeviceType: "x.com.st.d.sensor.motion") {
...
def configure() {
    ...
    delayBetween([
        ...
        zwave.configurationV1.configurationSet(configurationValue: [parameterThirteen], parameterNumber: 13, size: 1).format(),
        zwave.configurationV1.configurationSet(configurationValue: [parameterEighteen], parameterNumber: 18, size: 1).format(),
        zwave.configurationV1.configurationSet(configurationValue: [parameterTwenty], parameterNumber: 20, size: 1).format(),
        zwave.configurationV1.configurationSet(configurationValue: [parameterTwentyEight], parameterNumber: 28, size: 1).format()
    ], 500)
}